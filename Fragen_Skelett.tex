% Dokument ist ein Artikel
\documentclass{article}

% Dokumentensprache (Inhaltsverzeichnis, Überschriftenpräfix...) neue deutsche Rechtschreibung
\usepackage[ngerman]{babel}

% Eingabeformat auf UTF8 festlegen
\usepackage[utf8]{inputenc}

% Zeichensatzformat auf T1 setzen
\usepackage[T1]{fontenc}

\usepackage[babel,german=swiss]{csquotes}

% TODO: Hier die Metadaten eintragen
